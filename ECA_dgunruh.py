...
# ## First up will be the code with functions or classes
...
class ECA(object):
    ...
    def create_lookup_table(self, rule_number):
        ...
        try:
            ...
            raise ValueError("rule_number must be a non-negative integer")
...
def spacetime_diagram(spacetime_field, size=12, colors=plt.cm.get_cmap("Greys")):
    '''
